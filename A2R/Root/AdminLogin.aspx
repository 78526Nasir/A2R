...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container">
            <asp:Image ID="usericon" CssClass="img-style" ImageUrl="../Images/avatar1.png" AlternateText="User Icon" runat="server" />
            <br />
            ...
            <asp:Panel ID="pnlStatus" runat="server" CssClass="pnl-status">
